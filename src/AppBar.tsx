...
function AppBar() {
  ...
  return (
    <>
      <div className="draggable flex justify-between bg-slate-800 py-0.5 text-white">
        ...
        <div className="-mt-1 inline-flex">
          ...
          <button
            ...
            className="undraggable px-6 pt-1 hover:bg-gray-300 lg:px-5"
          >
            {isMaximize ? "\u2752" : "⃞"}
          </button>
          <button
      ...
      <div className="undraggable bg-slate-800 text-white">
